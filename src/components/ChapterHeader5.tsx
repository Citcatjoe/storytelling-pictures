 ...
 */
export function ChapterHeader5({
  titlePart1,
  titlePart2,
  chapterNumber,
  src,
  ...
  return (
    <header ref={headerRef} className="relative w-full md:mx-auto max-w-screen-2xl mb-8 md:mb-16 transition-all duration-300 group">
      {/* Background Figure/Container that dictates the height. */}
      <figure
        className={`relative -mx-4 w-[calc(100%+2rem)] md:mx-0 md:w-full overflow-hidden rounded-none md:rounded-2xl transition-all duration-300 aspect-(--header-ratio) ${
          hasBg
            ? "bg-black"
      ...
      {/* Box blanche de titre sous l'image */}
      {hasTitle && (
        <div className="relative z-10 mx-auto mt-6 md:mt-8 w-full max-w-[672px] bg-white px-0 flex flex-col items-start text-left transition-all duration-300">
          {formattedNumber && (
            <div className="flex flex-col items-start mb-2 md:mb-4 select-none">
              <span className="bg-accent2 px-1 py-0 text-md md:text-lg lg:text-xl font-mono font-black text-white uppercase tracking-wide">
          ...
          <h2 className="text-2xl md:text-4xl lg:text-5xl font-black tracking-tight leading-snug md:leading-tight text-gray-900">
